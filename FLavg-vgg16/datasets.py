...
def get_dataset(dir, name,conf):
    ...
    if name == "cifar100":
        ...
        train_datasets = datasets.CIFAR100(dir, train=True, download=True, transform=transform_train)
        test_dataset = datasets.CIFAR100(dir, train=False, transform=transform_test)
        train_dataset, _ = train_test_split(train_datasets, test_size=0.2, random_state=42)  # 4万个样本 1万个样本
